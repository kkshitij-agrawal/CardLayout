...
function selectElements() {
  ...
  mdtrigger = document.getElementsByClassName('md-trigger'),
  mdclose = document.getElementsByClassName('md-close'),
  mdModal = document.getElementsByClassName('md-modal');
}

function modal(){
  mdtrigger.addEventListener('click', ClassAdd);
  mdclose.addEventListener('clicl',ClassRemove);
}

function ClassAdd(){
  mdModal.addClass('md-show');
}


function ClassRemove(){
  mdModal.removeClass('md-show');
}
